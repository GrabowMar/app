...
# allauth is in HEADLESS_ONLY mode (no classic `account_login` URL is registered);
# login lives on the SvelteKit frontend at /auth/login/.
...
ADMINS = ['"Marcin Grabowski" <marcin27059@gmail.com>']
